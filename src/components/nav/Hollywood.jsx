...
const Hollywood = (props) => {
    ...
    useEffect(() => {
        if(arr.length > 0) {
            if(arr[arr.length-1].category == "Hollywood") {
                updateTrigger(true);
            }
        }
    }, [arr.length]);
    ...
    return (
        <div>
            ...
            <Article trigger={trigger} heading="Hollywood Articles" topArticles={[24, 39, 28]} cat="Hollywood"/>

            <Advertisementb />

            <TopPostsB start={s} items={[74, 25, 86]} cat="Hollywood"/>
